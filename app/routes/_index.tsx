      ...
      <div className="items-center spacey-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          <img
            ...
            className="h-48 w-48 rounded-full object-cover object-top ring-4 ring-teal-500 transition-transform duration-300 transform hover:scale-105"
          />
          <h3 className="pt-4 pb-2 text-2xl font-bold leading-8 tracking-tight">
            Amarnath A C
          </h3>
          <p className="text-gray-500 dark:text-gray-400 text-center">
            Hey my name is Amarnath and I am a Full Stack Developer
          </p>

          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/AmarnathAyyananChakkaravarthy" target="_blank" rel="noreferrer">
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/amarnathac/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a href="mailto:acamarnath4@gmail.com" target="_blank" rel="noreferrer">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
            ...
            <a href="https://x.com/AmarnathCreates" target="_blank" rel="noreferrer">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-8 dark:prose-invert xl:col-span-2">
          <p>
            Hey everyone my name is Amarnath, I am 25 years old and I am a Full Stack
